<x-layouts.app :title="__('Dashboard')">
    <div class="relative flex h-full max-h-[100vh] w-full flex-col gap-4 rounded-xl">
        <div
        ...
        <div
            class="flex flex-col flex-1 max-h-[600px]  gap-2 w-full overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
